                ...
                <div class="card-body">
                   ...
                   <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <label for="name" class="col-md-4 col-form-label text-md-left">{!! $KategoriBerita ->created_at!!}</label>
                      </div>

                      <div class="form-group row">
                        <label for="name" class="col-md-4 col-form-label text-md-right">Update</label>
                        <label for="name" class="col-md-4 col-form-label text-md-left">{!! $KategoriBerita ->updated_at!!}</label>
                      </div>
