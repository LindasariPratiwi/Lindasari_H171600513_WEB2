...
Route::post('/kategori_berita', 'BeritaController@store')->name('berita.store');
Route::get('/berita/{id}', 'BeritaController@show')->name('berita.show');

Route::get('/galeri', 'GaleriController@index')->name('galeri.index');
Route::get('/galeri/create', 'GaleriController@create')->name('galeri.create');
Route::post('/kategori_galeri', 'GaleriController@store')->name('galeri.store');
...
Route::post('/kategori_pengumuman', 'PengumumanController@store')->name('pengumuman.store');
